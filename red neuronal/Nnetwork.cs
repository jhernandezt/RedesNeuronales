...
namespace Neural_Networks
{
	...
	{
		private int i; // input
		private int o; // output
		private int h; // hidden
		...
		/// </summary>
		/// <param name="list"></param>
		public void TrainNetwork(double[,] inputlist, double[,] outputlist, int iterations, ProgressBar progressBar1)
		{
			inputsToNetwork = new double[this.i];
			desiredOutputs = new double[this.o];
			...
			for (int i = 0; i < iterations; i++)
			{
				...
				for (int sampleindex = 0; sampleindex < outputlistSampleLength; sampleindex++)
				{
					...
					// train for the next set of sample input and outputs
		...
		/// </summary>
		public string Test_Drive(int index, double[,] inputlist)
		{
